...
| `cells_pass.cpp` | ✅ instanced disc draw, SDF fragment shader; the predator branch on the render-only marker bit (M12b), coloured by N2 tolerance + the colourblind-safe Petrova LUT (M12e, ADR-039) | M1 |
