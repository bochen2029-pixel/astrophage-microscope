...
| File | Owns | Milestone |
|---|---|---|
| `hud.cpp` | ✅ clock, counts, fps, scope controls, population, energy ledger, the **NON-CANON RUN badge** (M11d), the **Timeline** scrubber slider (M12d, ADR-038), the **Tools** palette + brush cursor ring (M13a, ADR-040) | M1 |
